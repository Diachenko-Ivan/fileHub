...
class GetFolderContentRouteTest {
    ...
    @DisplayName("manage folder content view and return status 200.")
    @ParameterizedTest
    ...
    void testGetOfFolder(String folderIdParam) {
        ...
        GetFolderContentRoute getFolderContentRoute = new GetFolderContentRoute(new FileMetadataStorage(), mockFolderStorage);

        Request mockRequest = mockRequestWithParam(folderIdParam);
        Response mockResponse = mockResponse();

        getFolderContentRoute.handle(mockRequest, mockResponse);
